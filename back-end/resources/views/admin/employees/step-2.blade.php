...
<div class="col-lg-8 mb-5">
    <form action="/employees/create-step-2" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="email" value="{{ old('email_address') ? old('email_address') : session()->get('contact_detail.email_address') }}" type="text" placeholder="Enter Email Address" name="email_address" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="phone-number" value="{{ old('phone_number') ? old('phone_number') : session()->get('contact_detail.phone_number') }}" type="text" placeholder="0000-0000" name="phone_number" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="mobile-number" value="{{ old('mobile_number') ? old('mobile_number') : session()->get('contact_detail.mobile_number') }}" type="text" placeholder="0000-000-0000" name="mobile_number" />
