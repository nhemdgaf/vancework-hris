...
<div class="col-lg-8 mb-5">
    <form action="/employees/create-step-4" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputFirstName" value="{{ old('m_first_name') ? old('m_first_name') : session()->get('additional_information.m_first_name') }}" name="m_first_name" type="text" placeholder="Enter first name" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputLastName" value="{{ old('m_last_name') ? old('m_last_name') : session()->get('additional_information.m_last_name') }}" name="m_last_name" type="text" placeholder="Enter last name" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputMiddleName" value="{{ old('m_middle_name') ? old('m_middle_name') : session()->get('additional_information.m_middle_name') }}" name="m_middle_name" type="text" placeholder="Enter middle name" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputSuffix" value="{{ old('m_suffix') ? old('m_suffix') : session()->get('additional_information.m_suffix') }}" name="m_suffix" type="text" placeholder="Enter name suffix" />
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="econtactperson" value="{{ old('e_contact_person') ? old('e_contact_person') : session()->get('additional_information.e_contact_person') }}" name="e_contact_person" type="text" placeholder="Enter Contact Person" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="mobile-number" value="{{ old('e_mobile_number') ? old('e_mobile_number') : session()->get('additional_information.e_mobile_number') }}" name="e_mobile_number" type="text" placeholder="0000-000-0000" />
