...
<div class="col-lg-8 mb-5">
    <form action="/employees/create-step-1" method="post" autocomplete="off">
        @csrf
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputEmpNum" value="{{ old('emp_num') ? old('emp_num') : session()->get('employee.emp_num') }}" type=" text" placeholder="Enter Employee Number" name="emp_num" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputFirstName" value="{{ old('first_name') ? old('first_name') : session()->get('employee.first_name') }}" type="text" placeholder="Enter first name" name="first_name" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputLastName" value="{{ old('last_name') ? old('last_name') : session()->get('employee.last_name') }}" type="text" placeholder="Enter last name" name="last_name" />
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="inputMiddleName" value="{{ old('middle_name') ? old('middle_name') : session()->get('employee.middle_name') }}" type="text" placeholder="Enter middle name" name="middle_name" />
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="age" value="{{ old('age') ? old('age') : session()->get('employee.age') }}" type="number" placeholder="Enter Age" name="age" />
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="religion" value="{{ old('religion') ? old('religion') : session()->get('employee.religion') }}" type="text" placeholder="Enter Religion" name="religion" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="Citizenship" value="{{ old('citizenship') ? old('citizenship') : session()->get('employee.citizenship') }}" type="text" placeholder="Enter Citizenship" name="citizenship" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" id="pob" value="{{ old('place_of_birth') ? old('place_of_birth') : session()->get('employee.place_of_birth') }}" type="text" placeholder="Enter Place of Birth" name="place_of_birth" />
