...
<div class="col-lg-8 mb-5">
    <form action="/employees/create-step-5" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="sss" value="{{ old('sss') ? old('sss') : session()->get('contribution_number.sss') }}" name="sss" type="text" placeholder="00-000000000-0" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="philhealth" value="{{ old('philhealth') ? old('philhealth') : session()->get('contribution_number.philhealth') }}" name="philhealth" type="text" placeholder="00-000000000-0" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="pagibig" value="{{ old('pagibig') ? old('pagibig') : session()->get('contribution_number.pagibig') }}" name="pagibig" type="text" placeholder="0000-0000-0000" />
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="tin" value="{{ old('tin') ? old('tin') : session()->get('contribution_number.tin') }}" name="tin" type="text" placeholder="000-000-000" />
