...
<div class="col-lg-8 mb-5">
    <form action="/employees/create-step-7" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="card_holder" type="text" value="{{ old('card_holder') ? old('card_holder') : session()->get('atm_record.card_holder') }}" name="card_holder" placeholder="Card Holder">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="card_number" type="text" value="{{ old('card_number') ? old('card_number') : session()->get('atm_record.card_number') }}" name="card_number" placeholder="0000-0000-0000-0000">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <div class="input-group expiration-date">
                                        <input class="form-control item" id="expiry_date" type="text" value="{{ old('expiry_date') ? old('expiry_date') : session()->get('atm_record.expiry_date') }}" name="expiry_date" placeholder="MM/YY">
                                    </div>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control item" id="cvc" type="text" value="{{ old('cvc') ? old('cvc') : session()->get('atm_record.cvc') }}" name="cvc" placeholder="CVC">
