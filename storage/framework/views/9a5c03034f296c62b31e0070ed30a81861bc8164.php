...
<?php $__env->startSection('title'); ?> Dashboard - Vancework <?php $__env->stopSection(); ?>
                        ...
                        <div class="card-header d-flex justify-content-between align-items-center">
                            ...
                            <div class="dropdown no-arrow">
                                ...
                                <div class="dropdown-menu shadow dropdown-menu-right animated--fade-in"
                                    ...
                                    <a class="dropdown-item" role="presentation" href="#">&nbsp;Action
                                    </a>
                                    <a class="dropdown-item" role="presentation" href="#">&nbsp;Another action
                                    </a>
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            <div
                                ...
                                <span class="mr-2">
                                    <i class="fas fa-circle text-info"></i>&nbsp;Refferal
                                </span>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-auto">
                                    <div class="custom-control custom-checkbox"><input class="custom-control-input" type="checkbox" id="formCheck-1">
...
<?php echo $__env->make('admin.dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\vancework-hris\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>